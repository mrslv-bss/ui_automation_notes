...
def test_find_and_compare(get_driver):
    ...
    for b in range(10):
        ...
        product_title_loc = (By.XPATH, f"//div[@data-asin='{data_asin_element}'] //span[@class='a-size-base-plus a-color-base a-text-normal']")
        ...
        cursor.execute("INSERT INTO dbo.MYROSLAV_TABLE VALUES (%s, %s)", (price_loc, product_title))
        conn.commit()
